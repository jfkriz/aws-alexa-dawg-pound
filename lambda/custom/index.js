...
var streamInfo = {
  ...
  url2: 'https://streaming.radionomy.com/RadioXUS?lang=en-US&appName=iTunes.m3u',
  url: 'https://cbfc.streamguys1.com/cbdaily.mp3',
  image: {
...
var handlers = {
  ...
  'PlayCommandIssued': function() {
    ...
    this.response.speak('Here we go Brownies, here we go.  Woof Woof!').audioPlayerPlay('REPLACE_ALL', streamInfo.url, streamInfo.url, null, 0);
    this.emit(':responseReady');
  },
